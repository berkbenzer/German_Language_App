...
class GermanPractice:
    ...
    def practice_verbs(self):
        while True:
            ...
            position_of_random = self.verbs['first'].index(chosen_verb) 
            chosen_item = random.choice(list(self.verbs.keys()))
            chosen_item_value = self.verbs[chosen_item]
            ...
            if user_input_verbs == position_of_random_item:
               text = user_input_verbs
               print("User Input is Korrect")
        ...
        pass
    def practice_articles(self):
        while True:
            article = random.choice(list(self.words_data.keys()))
            german_word, word_data = random.choice(list(self.words_data[article].items()))
    ...
    def practice_translation(self):
        while True:
            article_tr = random.choice(list(self.words_data.keys()))
            german_word_tr, word_data = random.choice(list(self.words_data[article_tr].items()))
            turkish_meaning = word_data['turkish_meaning']
